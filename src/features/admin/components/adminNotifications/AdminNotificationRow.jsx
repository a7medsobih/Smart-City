...
const AdminNotificationRow = ({ notification, formatDate }) => {
    return (
        <tr className="hover:bg-primary-light/10 transition-colors">
            ...
            <td className="px-6 py-4 text-sm text-center text-nowrap text-gray-500">{formatDate(notification.sentDate)}</td>
